        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarPricePerDay = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelPricePerNight = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepatureAirport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ArrivialAirport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DepatureDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ArrivialDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HotelRentalId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelRentals_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelRentals_CustomerId",
                table: "HotelRentals",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelRentals_HotelId",
                table: "HotelRentals",
                column: "HotelId");
        }
